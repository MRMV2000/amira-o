...
-- Begin 'RondoMsgChecks' text checks by @UMBRAGE
-- Powered by @UMBRAGE & CopyRight all right reserved
...
-- End 'RondoMsgChecks' text checks by @UMBRAGE
   end
	return msg
end
